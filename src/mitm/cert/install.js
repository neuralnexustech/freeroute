...
const ROOT_CA_CN = "freeroute MITM Root CA";
...
async function installCertLinux(sudoPassword, certPath) {
  ...
  const config = getLinuxCertConfig();
  const destFile = `${config.dir}/freeroute-root-ca.crt`;

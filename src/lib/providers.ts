...
export const RAW_PROVIDERS_DATA = [
  ...
  },
  {
    ...
    category: "apikey" as const,
    icon: "blur_on",
    logoUrl: "https://img.logo.dev/mistral.ai?token=pk_TCFfDQFKSgKqWlRR0VCjOg",
    color: "#FF7000",
  ...
  },
  {
    ...
    icon: "group",
    logoUrl: "https://img.logo.dev/together.ai?token=pk_TCFfDQFKSgKqWlRR0VCjOg",
    color: "#0F6FFF",
  ...
  },
  {
    ...
    logoUrl: "https://img.logo.dev/fireworks.ai?token=pk_TCFfDQFKSgKqWlRR0VCjOg",
    color: "#9333EA",
  ...
  },
  {
    ...
    category: "freeTier" as const,
    icon: "search",
    logoUrl: "https://img.logo.dev/deepseek.com?token=pk_TCFfDQFKSgKqWlRR0VCjOg",
    color: "#1677FF",
  ...
  },
  {
    ...
    category: "freeTier" as const,
    icon: "waves",
    logoUrl: "https://img.logo.dev/cohere.com?token=pk_TCFfDQFKSgKqWlRR0VCjOg",
    color: "#39594D",
  ...
  },
  {
    ...
    category: "freeTier" as const,
    icon: "bolt",
    logoUrl: "https://img.logo.dev/novita.ai?token=pk_TCFfDQFKSgKqWlRR0VCjOg",
    color: "#7C3AED",
  ...
  },
  {
    ...
    icon: "link",
    logoUrl: "https://img.logo.dev/bazaarlink.ai?token=pk_TCFfDQFKSgKqWlRR0VCjOg",
    color: "#059669",

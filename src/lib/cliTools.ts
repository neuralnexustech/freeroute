...
export const MITM_TOOLS: MitmToolCard[] = [
  {
    ...
    subtitle: "Google Antigravity IDE with MITM",
    color: "linear-gradient(135deg, #4285F4, #1967D2)",
    icon: "/providers/antigravity.png",
    textIcon: "AG",
    website: "https://antigravity.google",
    mitmDomain: "daily-cloudcode-pa.googleapis.com",
    description: "Intercepts Google Antigravity IDE HTTPS traffic via local CA to redirect model calls to your combos or chosen providers.",
    defaultModels: [
      { id: "gemini-3.5-flash-low", name: "Gemini 3.5 Flash (Default)", alias: "gemini-3.5-flash-low", mandatory: true },
  ...
  },
  {
    id: "copilot",
    name: "GitHub Copilot",
    subtitle: "GitHub Copilot IDE & CLI with MITM",
    color: "linear-gradient(135deg, #1F6FEB, #1158C7)",
    icon: "/providers/copilot.png",
    textIcon: "GH",
    website: "https://github.com/features/copilot",
    mitmDomain: "api.individual.githubcopilot.com",
    secondaryDomains: ["api.githubcopilot.com"],
    description: "Intercepts GitHub Copilot VS Code & CLI HTTPS calls to dispatch requests to your selected combos or models.",
    defaultModels: [
      { id: "gpt-5-mini", name: "GPT-5 mini (CLI Default)", alias: "gpt-5-mini" },
      { id: "gpt-5.4-nano", name: "GPT-5.4 nano (Fast Auto)", alias: "gpt-5.4-nano" },
      { id: "claude-haiku-4.5", name: "Claude Haiku 4.5", alias: "claude-haiku-4.5" },
      { id: "gpt-4o", name: "GPT-4o (Chat Picker)", alias: "gpt-4o" },
  ...
  },
  {
    id: "kiro",
    name: "Kiro AI",
    subtitle: "Amazon Q / AWS IDE with MITM",
    color: "linear-gradient(135deg, #FF6B00, #D95700)",
    icon: "/providers/kiro.png",
    textIcon: "KR",
    website: "https://kiro.dev",
    mitmDomain: "runtime.us-east-1.kiro.dev",
    description: "Intercepts Kiro IDE agent and background task turns to redirect them to your custom combos or providers.",
    defaultModels: [
      { id: "auto", name: "Auto (Kiro Agent Main)", alias: "auto" },
      { id: "simple-task", name: "Simple Task / Background", alias: "simple-task" },
